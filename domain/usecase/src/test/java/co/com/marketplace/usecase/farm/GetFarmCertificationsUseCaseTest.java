...
class GetFarmCertificationsUseCaseTest {
    ...
    @Test
    void execute_returnsCertifications_whenAllFound() {
        ...
        FarmCertification cert = FarmCertification.builder().id(UUID.randomUUID())
        ...
        when(farmGateway.findCertificationsByFarmId(farmId)).thenReturn(Flux.just(cert));
